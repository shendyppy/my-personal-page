    ...
    >
      <div className="max-w-6xl w-full flex flex-col gap-8 md:gap-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-4 md:gap-6 items-start">
          ...
          {/* Photo and Socials container */}
          <div className="lg:col-span-4 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            {/* Photo */}
            <div className="col-span-2 flex flex-col transition-all duration-300 hover:translate-y-[-4px] hover:shadow-xl gap-2">
              <Image
              ...
              <Card className="p-4 md:p-6 rounded-xl">
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Recently, I’ve been revisiting the backend, DevOps, and even
                  dipping my toes into LLMs — learning my way through Node.js,
                  Nest.js, ORMs, Python, and the world of CI/CD and deployment.
                  I’m still early on this path, but my aim is clear: to
                  eventually feel just as comfortable building systems behind
                  the scenes as I do shaping the UI up front.
                </p>
              </Card>
            </div>

            {/* Social buttons - now better centered and responsive */}
            <div className="flex flex-row md:flex-col justify-center items-center md:justify-start gap-4">
              {items.map((item, i) => (
                <Button
                  key={i}
                  variant="outline"
                  ...
                  className="size-14 md:size-16 rounded-full transition-all duration-300 transform hover:scale-110 hover:shadow-lg flex items-center justify-center"
                >
