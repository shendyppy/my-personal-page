              ...
              <div className="space-y-8">
                {highlight.images.map((img, i) => (
                  ...
                  >
                    ...
                    <div className="absolute top-6 right-6 bg-black/30 backdrop-blur-md text-white text-sm px-3 py-1.5 rounded-full font-medium opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-2 group-hover:translate-y-0">
                      {i + 1} / {highlight.images.length}
                    </div>

                    {img.isScrollable && (
                      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-gray-500 text-sm opacity-60 group-hover:opacity-0 transition-all duration-500 flex items-center gap-2">
